        ...
        <div class="col-lg-12 d-flex align-items-strech">
            <div class="card w-100">
                <div class="card-header">
                    <h5 class="card-title fw-semibold">Edit Data Mahasiswa</h5>
                </div>
                    ...
                    <form action="/admin/mahasiswa/{{ $mahasiswa->id }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md 6">
                                ...
                                <div class="mb-3">
                                    <label for="no_induk" class="form-label">Nomor Pokok Mahasiswa (NPM)<span
                                            style="color: red">*</span></label>
                                    ...
                                    <select class="form-control" name="prodi_id" id="prodi_id">
                                        @foreach ($prodies as $prodi)
                                            <option value="{{ $prodi->id }}"
                                                @if ($mahasiswa->prodi_id == $prodi->id) selected @endif>
                                                {{ $prodi->program_studi }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <a href="/admin/mahasiswa" class="btn btn-light float-end">Kembali</a>
