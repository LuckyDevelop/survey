...
@section('content')
        ...
        <div class="row">
            <div class="col">
                <div class="card card-primary">
                    <div class="card-body">
                        <form action="/admin/jenis-survey" method="POST">
                            @csrf
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="input_type_id" id="input_type_id" class="form-control">
                                                ...
                                                @foreach ($inputTypes as $inputType)
                                                    <option value="{{ $inputType->id }}">{{ $inputType->input_type }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('input_type_id')
    ...
    <script>
        document.getElementById('input_type_id').addEventListener('change', function() {
            ...
            if (selectedOption === '1') {
                dynamicFormContainer.innerHTML = `
                    <div class="form-group row" id="skalaLikertForm">
                        <div class="col-md-6">
                            <label for="radioLabels">Label Skala Likert</label>
                ...
                dynamicFormContainer.innerHTML = `
                    <div class="form-group row" id="selectForm">
                        <div class="col-md-6">
                            <label for="selectLabels">Value Option Select</label>
                            <input type="text" name="label[]" class="form-control">
                        </div>
                        <div class="col-md-4 mt-4">
                            <label for="selectValues"></label>
                            <button type="button" class="btn btn-danger btn deleteForm">Hapus</button>
                        </div>
                    </div>
                    <hr>
                ...
                dynamicFormContainer.innerHTML = `
                    <div class="form-group row" id="radioForm">
                        <div class="col-md-6">
                            <label for="selectLabels">Label Radio Button</label>
                            <input type="text" name="label[]" class="form-control">
                        </div>
                        <div class="col-md-4 mt-4">
                            <label for="selectValues"></label>
